...
BEGIN
	BEGIN TRAN
		IF NOT EXISTS (SELECT * FROM SANPHAM WHERE SANPHAM.MaSP = @MASP )
		BEGIN
			ROLLBACK
...
execute THEMSANPHAM @MaSP = 'sp0000',  @MaCN = 'cn0000',  @TenSP = N'Chocopie', @MoTa = null, @Gia = 30000   
go
...
go
exec KHACHHANG_XEMSANPHAM @MaSP = N'SP0008'
